...
public class GPSDataDialog extends Activity {
    ...
    private LinkedList<DialogGPSAcceptedListener> listeners;
    ...
    public void addListener(DialogGPSAcceptedListener futureListener){
        this.listeners.push(futureListener);
    }

    private void notifyListeners(String gpsname, String gpsid, String view){
        for(DialogGPSAcceptedListener listener : listeners){
